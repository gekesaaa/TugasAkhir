# =====================================================
# UI ANALISIS KOMPARASI: RAG+RTE VS Llama 
...
if (
    ...
    try:
        answer_llama = generate_llama_content(
            llama_prompt,
            temperature=0.4
        )
...
# =====================================================
col_predict, col_llama = st.columns(2, gap="large")
